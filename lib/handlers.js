            ...
            if(!error && userData){
                ...
                if(hashedPassword == userData.hashedPassword){
                    ...
                    _data.create('tokens', tokenId, tokenObject, (error) => {
                        ...
                        _performance.measure('Start to end', 'function entered', 'storing token complete');
                        _performance.measure('Validating user inputs', 'function entered', 'inputs validated');
                        ...
                        measurements.forEach((mesaure) => {
                            debug('\x1b[33m%s\x1b[0m', mesaure.name+' '+mesaure.duration);
                        });
