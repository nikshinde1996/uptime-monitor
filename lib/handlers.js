...
handlers._checks.push = (data, callback) => {
    var phone = typeof(data.payload.protocol) === 'string' && ['http','https'].indexOf(data.payload.protocol) > -1 ? data.payload.protocol : false;
    ...
    if(phone && url && method && successCodes && timeoutSeconds) {
